      ...
      <main className="mt-10 mx-auto mb-10 max-w-7xl px-4 sm:mb-12 sm:px-6 md:mb-16 lg:mb-20 lg:px-8 xl:mb-28">
        <div className="sm:text-center lg:text-left">
          ...
          <p className="mt-3 text-base text-gray-500 sm:mx-auto sm:mt-5 sm:max-w-xl sm:text-lg md:mt-5 md:text-xl lg:mx-0">
            Focal seeks to act as a personal assistant, with a schedule calendar
            that integratres with a pomodoro focus timer for deep and meaningful
            work, the ability to divide and conquer more long term goals using
            projects, and allowing users to customize focus settings to maximize
            productivity!
          </p>
